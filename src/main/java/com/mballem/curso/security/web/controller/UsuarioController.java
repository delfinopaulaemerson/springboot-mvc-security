...
public class UsuarioController {
	...
	public String salvarUsuarios(Usuario usuario, RedirectAttributes attr) {
		...
		if (perfis.size() > 2 || perfis.containsAll(Arrays.asList(new Perfil(1L), new Perfil(3L)))
			...
			attr.addFlashAttribute("falha", "Paciente não pode ser admin ou médico!");
			...
			try {
				...
				attr.addFlashAttribute("falha", "Cadstro não realizado, Email já existente!");
			}
		}
	...
	public ModelAndView preEditarCredenciais(@PathVariable("id") Long id) {
		return new ModelAndView("usuario/cadastro", "usuario", this.service.findById(id));
	}
	...
	public ModelAndView preEditarCadastroDadosPessoais(@PathVariable("id") Long usuarioId,
		...
		Usuario us = this.service.findByIdAndPerfis(usuarioId, perfisId);
		...
		if (us.getPerfis().contains(new Perfil(PerfilTipo.ADMIN.getCod()))
			...
			Medico medico = this.medicoService.findByUsuarioId(usuarioId);
	...
	public String salvarCadastroPaciente(Usuario usuario, BindingResult result) throws Exception {
		try {
	...
	public String respostaConfirmacaoCadastroPaciente(@RequestParam("codigo") String codigo, RedirectAttributes attr) {
		this.service.ativarCadastroPacinte(codigo);
	...
	public String redefinirSenha(String email, ModelMap model) throws Exception {
		this.service.pedidoRedefinicaoDeSenha(email);
	...
	public String confirmacaoDeRedefinicaoDeSenha(Usuario usuario, ModelMap model) {
		Usuario u = this.service.findByEmail(usuario.getEmail());
