...
public class EmailService {
	...
	public void enviarPedidoDeComfirmacaoDeCadastro(String destino, String codigo) throws Exception {
		...
		String html = this.template.process("email/confirmacao", context);
		
		helper.setTo("worktestdeveloper@gmail.com");
		helper.setText(html, true);
		helper.setSubject("Confirmação de Cadastro");
		helper.setFrom("worktestdeveloper@gmail.com");
		helper.addInline("logo", new ClassPathResource("/static/image/spring-security.png"));
		
		this.mailSender.send(message);
	}
	
	public void enviarPedidoRedefinicaoSenha(String destino, String verificador) throws Exception {
